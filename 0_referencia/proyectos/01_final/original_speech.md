...
<!-- type:SPLIT_LEFT // BDI // Arquitectura de agente inspirada en la filosofía de la mente humana: Creencias, Deseos e Intenciones -->
...
<!-- type:CONCEPT // ¿Qué arquitectura es mejor? // No hay una arquitectura mejor que otra, solo la más apropiada para determinado caso de uso -->
