...
ejecuta `npx remotion render` por cada asset, guarda en data/assets/{class_id}/videos/.
"""
import json
import os
import shutil
...
def run_remotion(class_id: int) -> None:
    ...
    try:
        ...
        app_dir    = Path(os.path.dirname(os.path.dirname(__file__)))  # app/
        data_dir   = app_dir.parent / "data"
        assets_dir = data_dir / "assets" / str(class_id) / "videos"
